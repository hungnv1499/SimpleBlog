...
<html>
    ...
    <body>
        ...
        <div class="container text-center padding-vertical-50">
            <h2 class="double-line"><span>Simple blog</span></h2>
                            ...
                            <div class="sidebar-search padding-bottom-10">
                                <div class="row justify-content-md-center">
                                    <div class="col-md-8 form-group">
                                        <input type="text" name="txtContentSearch" id="txt_Search" class="form-control" placeholder="Search by content...">
                                    </div>
                                ...
                                <div class="blog-list">
                                    <div class="container padding-vertical-10 col-md-12 col-lg-12">
                                        <table border="1" class="table tab-content" id="table-content">
                                            <thead>
                                                <tr class="row">
                                                    <th class="col-md-12 col-sm-12 padding-bottom-30" ><h2>Article</h2></th>
                                            </tr>
                                            </thead>
    ...
    <script type="text/javascript">
        ...
        function getArticleList(pageI, max) {
            var content = "";
            ...
            $.ajax({
                ...
                data: {action: "GetArticle", pageIndex: pageI, maxS: max, content: content, sort: sort},
                headers: {
                ...
                success: function (data, textStatus, jqXHR) {
                    ...
                    $.each(listObj.listArticles, function (i, item) {
                        tbody_html = '<tr class="row">' +
                                ...
                                '<div class=" blog-short-description ">' +
                                '<div class="post-title padding-vertical-10" style="font-weight: bold;" >' +
                                '<h3><a href="MainController?action=ShowDetail&id=' + item.id + '" >' + item.title + '</a> </h3>' +
                                '</div>' +
                                '<div class="post-info padding-top-5">' +
